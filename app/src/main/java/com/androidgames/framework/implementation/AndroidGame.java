...
public abstract class AndroidGame extends Activity implements Game {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int frameBufferHight = isLandscape ? 320:480;
        Bitmap frameBuffer = Bitmap.createBitmap(frameBufferWidth,frameBufferHight, Bitmap.Config.RGB_565);

        scaleX = (float) frameBufferWidth/getWindowManager().getDefaultDisplay().getWidth();
        scaleY = (float) frameBufferHight/getWindowManager().getDefaultDisplay().getHeight();
